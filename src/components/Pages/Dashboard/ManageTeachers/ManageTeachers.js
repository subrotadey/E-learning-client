...
const ManageTeachers = () => {
    ...
    return (
        <div>
                  ...
                  <tbody>
                    {teachers?.map((teacher, i) => (
                      <tr key={teacher._id} className="hover">
                        ...
                        <td>
                            {
                                teacher?.role !== 'admin' && <label onClick={() => setDeletingTeacher(teacher)}  htmlFor="confirmation-modal" className="btn btn-sm btn-error">Delete</label>
                            }
                        </td>
                        <td>
            ...
            {
                deletingTeacher && <ConfirmationModal
