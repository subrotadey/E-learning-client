        ...
        <div>
            ...
            <form onSubmit={handleSubmit(handleAddTeacher)}>
                    <div className="form-control w-full max-w-xs">
                        <label className="label"> <span className="label-text">Teacher First Name</span></label>
                    ...
                    <div className="form-control w-full max-w-xs">
                        <label className="label"> <span className="label-text">Teacher Last Name</span></label>
                    ...
                    <input className='btn btn-accent w-full mt-4' value="Add Teacher" type="submit" />
                </form>
        </div>
        </div>
    );
